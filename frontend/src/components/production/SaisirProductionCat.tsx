...
/* ═══════════════════════════════════════════════════════════════
   FORMULAIRE DE SAISIE — PRODUCTION CAT UNIQUEMENT
   Volontairement indépendant d'AXA et Cover EDGE. Pas de
...
const COMPANY_CODE = 'CAT';
const RETURN_PATH  = '/production-cat';
...
export function SaisirProductionCat() {
  ...
  const onSubmit = (data: FormData) => {
    if (!companyId) { toast.error("Compagnie CAT introuvable — contactez l'administrateur"); return; }
          ...
          <div className="card p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" className="input" placeholder="Ex: CAT-2024-000123" {...register('contractNumber')} />
